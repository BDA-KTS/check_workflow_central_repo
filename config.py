...
class Settings:
    ...
    AGGREGATION_PATH: Path = "aggregation"
    OUTPUT_PATH: dict = {"report_creator":"central/review_outputs",
                         "public_report_creator":"central/public_outputs"}
    ML_PATH: Path = CENTRAL_PATH / "models"
    ...
    FREE_LICENSES: list[str]=["Apache-2.0", "MIT", "BSD-2-Clause", "BSD-3-Clause", "ISC", "Zlib", "BSL-1.0", "GNU", "GPL-3.0","CCO-1.0","AGPL-3.0","EUPL-1.1","EUPL-1.2","LGPL-2.1"]
